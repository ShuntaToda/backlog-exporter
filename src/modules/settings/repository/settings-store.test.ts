...
import {FolderType, Settings} from '../domain/settings.js'
import {getSettingsFilePath, loadSettings, saveSettings, updateSettings} from './settings-store.js'

describe('settings-store - 設定ファイル管理', () => {
  let tempDir: string
